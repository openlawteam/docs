...
El lenguaje de marcado de OpenLaw acepta las expresiones booleanas según lo siguiente:
...
Cuando se combinan las condicionales con las expresiones booleanas anteriores, el poder expresivo del lenguaje enmarcado de OpenLaw se aprecía más. Por ejemplo, imagina que quieres incluir una disposición adicional en un acuerdo--digamos el requisito de que las partes saquen una póliza de seguro--si el valor total del acuerdo excediera una cierta cantidad en dólares, fácilmente se podría hacer como se ve en lo siguiente.
