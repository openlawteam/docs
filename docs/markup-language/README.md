...
*Important Note*: ERC-712 doesn't protect you from replay attacks out of the box. You will need to take it into account when you develop your smart contract. The fact that it doesn't protect is useful if you need to do recurring calls.
